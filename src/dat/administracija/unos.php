...
function provjera() {
    if ($_GET['cl']) {
        $result = query_to_result("SELECT * FROM clanci WHERE id='".$_GET['cl']."';");
...
function forma1() {
    echo '<h1 class="promjenanaslov">UNOS ČLANKA</h1>';
    ...
    echo '';
    echo '<label for="a1">Arhiv: da<input type="radio" id="a1" name="arhiva" value="a1"></label>';
    echo '<label for ="a0">ne<input type="radio" id="a0" name="arhiva" value="a0"></label><br>';
...
function forma2($datum,$naslov,$slika,$kratki,$tekst,$kategorija,$arhiva) {
    $sl = '../../.'.$slika;
    echo '<h1 class="promjenanaslov">IZMJENA ČLANKA</h1>';
    ...
    if ($arhiva == 1) {
        echo '<label for="a1">Arhiv: da<input type="radio" id="a1" name="arhiva" value="a1" checked></label>';
        echo '<label for ="a0">ne<input type="radio" id="a0" name="arhiva" value="a0"></label><br>';}
    else {
        echo '<label for="a1">Arhiv: da<input type="radio" id="a1" name="arhiva" value="a1"></label>';
        echo '<label for ="a0">ne<input type="radio" id="a0" name="arhiva" value="a0" checked></label><br>';}
